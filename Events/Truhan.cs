...
public class Truhan : Events//Espesifications in Event class
{
    ...
    public static new string Description => @"Vez como el truhán engaña a las personas y tu desides hacer algo por ellas : vencer al truhán o 
    ...
    {
        var InformativePanel = new Panel(@"[green]El truhán no pudo escapar a tiempo y te habla de forma indesente y entonses tomas su linda 
